...
namespace Acb.Gateway.Payment.Controllers
{
    ...
    public class NotifyController : DController
    {
        ...
        {
            _logger = LogManager.Logger<NotifyController>();
        ...
        public async Task Index()
        {
            ...
            {
                Type = Acb.Payment.Contracts.Enums.NotifyType.Receive,
                Url = AcbHttpContext.RawUrl,
            ...
            {
                LogManager.Logger<NotifyController>().Error(ex.Message, ex);
